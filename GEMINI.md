...
| **`planning`** | Lập kế hoạch kỹ thuật có khả năng mở rộng, bảo mật và dễ bảo trì. |
...
---
**Ghi chú:** Khi nhận yêu cầu, tôi sẽ tự động kích hoạt kỹ năng phù hợp nhất dựa trên bảng tra cứu này.